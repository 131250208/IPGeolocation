...
def merge_near_locations(candidates_list, max_distance):
    ...
    for pair in pair_list:
        c1 = pair[0]["cluster"][0]
        c2 = pair[1]["cluster"][0]
        dis = get_geodistance_btw_2coordinates(c1["candidate"]["longitude"], c1["candidate"]["latitude"],
    ...
    while True:
        print("-----len_clusters: %d------------" % len(clusters_list))
        pair_list = combinations(clusters_list, 2)
        dis_min = 9999999999
        pair_closest = None
        for pair in pair_list:
    ...
    for cluster in clusters_list:
        ...
        if len(cluster) == 1:
            ...
            can = get_stdev_coordinates(candidates)[1]
...
if __name__ == "__main__":
    # 19.50139 to 64.85694 and longitude from -161.75583 to -68.01197.


    # print(get_geodistance_btw_2coordinates(-161.90583, 19.50139, -161.75583, 19.50139))
    # locations = [{'longitude': -122.270001, 'latitude': 37.8055388}, {'longitude': -87.858491, 'latitude': 37.8055388},
    #              {'longitude': -122.270001, 'latitude': 37.8055388}, {'longitude': -87.858491, 'latitude': 41.87776059999999},]
    # print(merge_near_locations(locations, 200000))
    pass
